...
class _$TransactionDocumentResponseImpl
  ...
  @override
  String toString() {
    return 'TransactionDocumentResponse(orderId: $orderId, campaignId: $campaignId, campaignName: $campaignName, campaignImage: $campaignImage, amount: $amount, paymentStatus: $paymentStatus, userId: $userId, createdAt: $createdAt)';
  }
...
abstract class _TransactionDocumentResponse
  ...
  factory _TransactionDocumentResponse(
      ...
      final String? paymentStatus,
      final String? userId,
      final String? createdAt}) = _$TransactionDocumentResponseImpl;
