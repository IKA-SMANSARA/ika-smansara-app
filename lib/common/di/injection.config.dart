...
import 'package:ika_smansara/auth/auth.dart' as _i7;
...
import 'package:ika_smansara/auth/domain/use_case/user_register_use_case/user_register_use_case.dart'
    as _i38;
import 'package:ika_smansara/common/common.dart' as _i9;
import 'package:ika_smansara/common/data/remote/api_services.dart' as _i5;
import 'package:ika_smansara/common/data/remote/api_services_payment_gateway.dart'
    as _i6;
import 'package:ika_smansara/common/di/application_module.dart' as _i46;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i3.Client>(() => applicationModule.appwriteClient);
    gh.lazySingleton<_i3.Databases>(() => applicationModule.appwriteDatabase);
    gh.lazySingleton<_i3.Storage>(() => applicationModule.appwriteStorage);
    gh.factory<String>(
      () => applicationModule.paymentGatewayBaseURL,
    ...
    gh.lazySingleton<_i4.ChopperClient>(
      () => applicationModule.paymentGatewayClient(
          gh<String>(instanceName: 'BASEURLPAYMENTGATEWAY')),
      instanceName: 'PAYMENTGATEWAYNETWORKMODULE',
    );
    gh.lazySingleton<_i4.ChopperClient>(() =>
        applicationModule.chopperClient(gh<String>(instanceName: 'BASEURL')));
    gh.lazySingleton<_i5.ApiServices>(
        () => applicationModule.apiServices(gh<_i4.ChopperClient>()));
    gh.lazySingleton<_i6.ApiServicesPaymentGateway>(() =>
        applicationModule.apiServicesPaymentGateway(gh<_i4.ChopperClient>(
            instanceName: 'PAYMENTGATEWAYNETWORKMODULE')));
    gh.factory<_i7.AuthRepository>(
        () => _i8.AuthRepositoryImpl(gh<_i9.ApiServices>()));
    gh.factory<_i10.DetailCampaignRepository>(
        () => _i11.DetailCampaignRepositoryImpl(gh<_i9.ApiServices>()));
    gh.factory<_i12.DetailMyDonationRepository>(
        () => _i13.DetailMyDonationRepositoryImpl(gh<_i9.ApiServices>()));
    gh.factory<_i14.GetDetailCampaignUseCase>(() =>
        _i14.GetDetailCampaignUseCase(gh<_i10.DetailCampaignRepository>()));
    gh.factory<_i15.GetDetailMyDonationUseCase>(() =>
        _i15.GetDetailMyDonationUseCase(gh<_i12.DetailMyDonationRepository>()));
    gh.factory<_i16.GetIdEmailSessionFromLocalUseCase>(
        () => _i16.GetIdEmailSessionFromLocalUseCase(gh<_i7.AuthRepository>()));
    gh.factory<_i17.GetLabelUserFromLocalUseCase>(
        () => _i17.GetLabelUserFromLocalUseCase(gh<_i7.AuthRepository>()));
    gh.factory<_i18.GetListBackerUseCase>(
        () => _i18.GetListBackerUseCase(gh<_i10.DetailCampaignRepository>()));
    gh.factory<_i19.GetUserAccountDetailUseCase>(
        () => _i19.GetUserAccountDetailUseCase(gh<_i7.AuthRepository>()));
    gh.factory<_i20.HomeRepository>(
        () => _i21.HomeRepositoryImpl(gh<_i9.ApiServices>()));
    gh.factory<_i22.ListCampaignPerCategoryRepository>(() =>
        _i23.ListCampaignPerCategoryRepositoryImpl(gh<_i9.ApiServices>()));
    gh.factory<_i24.ListMyDonationRepository>(
        () => _i25.ListMyDonationRepositoryImpl(gh<_i9.ApiServices>()));
    gh.factory<_i26.PaymentGatewayRepository>(
        () => _i27.PaymentGatewayRepositoryImpl(
              gh<_i9.ApiServicesPaymentGateway>(),
              gh<_i9.ApiServices>(),
            ));
    gh.factory<_i28.RegisterRepository>(
        () => _i29.RegisterRepositoryImpl(gh<_i9.ApiServices>()));
    ...
    gh.factory<_i31.SaveIdEmailSessionToLocalUseCase>(
        () => _i31.SaveIdEmailSessionToLocalUseCase(gh<_i7.AuthRepository>()));
    gh.factory<_i32.SaveLabelUserToLocalUseCase>(
        () => _i32.SaveLabelUserToLocalUseCase(gh<_i7.AuthRepository>()));
    ...
    gh.factory<_i36.UserLoginUseCase>(() => _i36.UserLoginUseCase(
          ...
          gh<_i7.SaveIdEmailSessionToLocalUseCase>(),
          gh<_i7.GetUserAccountDetailUseCase>(),
          gh<_i7.SaveLabelUserToLocalUseCase>(),
        ));
    gh.factory<_i37.UserLogoutUseCase>(() => _i37.UserLogoutUseCase(
          gh<_i7.AuthRepository>(),
          gh<_i7.GetIdEmailSessionFromLocalUseCase>(),
        ));
    gh.factory<_i38.UserRegisterUseCase>(
        () => _i38.UserRegisterUseCase(gh<_i7.AuthRepository>()));
    gh.factory<_i39.CheckUserIsAdminUseCase>(() =>
        _i39.CheckUserIsAdminUseCase(gh<_i7.GetLabelUserFromLocalUseCase>()));
    ...
    gh.factory<_i42.GetAllCampaignsUseCase>(
        () => _i42.GetAllCampaignsUseCase(gh<_i20.HomeRepository>()));
    gh.factory<_i43.GetCarouselUseCase>(
        () => _i43.GetCarouselUseCase(gh<_i20.HomeRepository>()));
    gh.factory<_i44.GetCategoriesUseCase>(
        () => _i44.GetCategoriesUseCase(gh<_i20.HomeRepository>()));
    gh.factory<_i45.GetMyDonationUseCase>(
        () => _i45.GetMyDonationUseCase(gh<_i24.ListMyDonationRepository>()));
    return this;
  }
}

class _$ApplicationModule extends _i46.ApplicationModule {}
