...
import 'package:ika_smansara/common/di/api_interface_network_module.dart'
    as _i27;
import 'package:ika_smansara/common/di/network_module.dart' as _i28;
...
import 'package:ika_smansara/register/domain/use_case/save_user_profile_doc_use_case/save_user_profile_doc_use_case.dart'
    as _i20;
import 'package:ika_smansara/register/register.dart' as _i15;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i5.PaymentGatewayRepository>(() =>
        _i14.PaymentGatewayRepositoryImpl(gh<_i5.ApiServicesPaymentGateway>()));
    gh.factory<_i15.RegisterRepository>(
        () => _i16.RegisterRepositoryImpl(gh<_i4.ApiServices>()));
    gh.factory<_i17.RequestAcquiringTransactionTokenUseCase>(() =>
        _i17.RequestAcquiringTransactionTokenUseCase(
            gh<_i5.PaymentGatewayRepository>()));
    gh.factory<_i18.SaveIdEmailSessionToLocalUseCase>(
        () => _i18.SaveIdEmailSessionToLocalUseCase(gh<_i6.AuthRepository>()));
    gh.factory<_i19.SaveLabelUserToLocalUseCase>(
        () => _i19.SaveLabelUserToLocalUseCase(gh<_i6.AuthRepository>()));
    gh.factory<_i20.SaveUserProfileDocUseCase>(
        () => _i20.SaveUserProfileDocUseCase(gh<_i15.RegisterRepository>()));
    gh.factory<_i21.UpdateCounterDataUseCase>(
        () => _i21.UpdateCounterDataUseCase(gh<_i8.CounterRepository>()));
    ...
    gh.factory<_i23.UserLogoutUseCase>(() => _i23.UserLogoutUseCase(
          gh<_i6.AuthRepository>(),
          gh<_i6.GetIdEmailSessionFromLocalUseCase>(),
        ));
    gh.factory<_i24.UserRegisterUseCase>(
        () => _i24.UserRegisterUseCase(gh<_i6.AuthRepository>()));
    gh.factory<_i25.CheckUserIsAdminUseCase>(() =>
        _i25.CheckUserIsAdminUseCase(gh<_i6.GetLabelUserFromLocalUseCase>()));
    gh.factory<_i26.CheckUserSessionStatusUseCase>(
        () => _i26.CheckUserSessionStatusUseCase(
              gh<_i6.AuthRepository>(),
              gh<_i6.GetIdEmailSessionFromLocalUseCase>(),
            ));
    return this;
...
class _$ApiInterfaceNetworkModule extends _i27.ApiInterfaceNetworkModule {}

class _$NetworkModule extends _i28.NetworkModule {}

class _$ApiInterfacePaymentGatewayNetworkModule
    extends _i29.ApiInterfacePaymentGatewayNetworkModule {}

class _$PaymentGatewayNetworkModule extends _i30.PaymentGatewayNetworkModule {}
