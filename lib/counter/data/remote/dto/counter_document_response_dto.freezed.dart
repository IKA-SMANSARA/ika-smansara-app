...
CounterDocumentResponseDTO _$CounterDocumentResponseDTOFromJson(
    Map<String, dynamic> json) {
  return _CounterDocumentResponseDTO.fromJson(json);
}
...
/// @nodoc
abstract class $CounterDocumentResponseDTOCopyWith<$Res> {
  factory $CounterDocumentResponseDTOCopyWith(CounterDocumentResponseDTO value,
...
/// @nodoc
class _$CounterDocumentResponseDTOCopyWithImpl<$Res,
        $Val extends CounterDocumentResponseDTO>
    implements $CounterDocumentResponseDTOCopyWith<$Res> {
  _$CounterDocumentResponseDTOCopyWithImpl(this._value, this._then);
...
class _$CounterDocumentResponseDTOImpl implements _CounterDocumentResponseDTO {
  ...
  @override
  String toString() {
    return 'CounterDocumentResponseDTO(id: $id, collectionId: $collectionId, databaseId: $databaseId, createdAt: $createdAt, updatedAt: $updatedAt, permissions: $permissions, counterValue: $counterValue)';
  }
...
abstract class _CounterDocumentResponseDTO
    implements CounterDocumentResponseDTO {
  const factory _CounterDocumentResponseDTO(
