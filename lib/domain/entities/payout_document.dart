...
class PayoutDocument with _$PayoutDocument {
  factory PayoutDocument({
    ...
    @JsonKey(name: 'beneficiary_name') String? realName,
    @JsonKey(name: 'beneficiary_bank') String? bankCode,
    @JsonKey(name: 'beneficiary_account') String? accountBankNumber,
    @JsonKey(name: 'beneficiary_email') String? email,
