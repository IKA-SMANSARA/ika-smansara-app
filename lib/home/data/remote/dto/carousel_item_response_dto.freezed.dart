...
CarouselItemResponseDTO _$CarouselItemResponseDTOFromJson(
    Map<String, dynamic> json) {
  return _CarouselItemResponseDTO.fromJson(json);
}
...
mixin _$CarouselItemResponseDTO {
  ...
  @JsonKey(ignore: true)
  $CarouselItemResponseDTOCopyWith<CarouselItemResponseDTO> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CarouselItemResponseDTOCopyWith<$Res> {
  factory $CarouselItemResponseDTOCopyWith(CarouselItemResponseDTO value,
          $Res Function(CarouselItemResponseDTO) then) =
...
/// @nodoc
class _$CarouselItemResponseDTOCopyWithImpl<$Res,
        $Val extends CarouselItemResponseDTO>
    implements $CarouselItemResponseDTOCopyWith<$Res> {
  _$CarouselItemResponseDTOCopyWithImpl(this._value, this._then);
